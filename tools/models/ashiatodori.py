...
HOOD = [
    ...
    (-22.0, 0.60, (0.0455, -0.0950, 0.2215), 0.0154, 3),
    (-13.0, 0.56, (0.0445, -0.0900, 0.2270), 0.0156, 1),
    (-4.0, 0.52, (0.0428, -0.0850, 0.2325), 0.0158, 0),
    (6.0, 0.48, (0.0405, -0.0780, 0.2380), 0.0156, 2),
    (16.0, 0.44, (0.0375, -0.0710, 0.2440), 0.0154, 2),
    (23.0, 0.42, (0.0350, -0.0670, 0.2495), 0.0150, 0),
    (30.0, 0.41, (0.0305, -0.0630, 0.2560), 0.0148, 1),
    (40.0, 0.38, (0.0105, -0.0570, 0.2690), 0.0142, 3),   # 全高の頂点
    (52.0, 0.36, (0.0230, -0.0500, 0.2600), 0.0142, 0),
    # 下の層。ひとつ外へずらして重なりを作る
    (-26.0, 0.74, (0.0500, -0.1020, 0.1980), 0.0164, 1),
    (-17.0, 0.70, (0.0505, -0.0970, 0.2035), 0.0166, 2),
    (-8.0, 0.66, (0.0500, -0.0910, 0.2090), 0.0166, 3),
    (3.0, 0.62, (0.0460, -0.0840, 0.2150), 0.0162, 0),
    (14.0, 0.58, (0.0420, -0.0770, 0.2215), 0.0160, 0),
    (27.0, 0.55, (0.0390, -0.0690, 0.2275), 0.0156, 2),
    (40.0, 0.52, (0.0360, -0.0610, 0.2330), 0.0152, 2),
    (50.0, 0.50, (0.0325, -0.0550, 0.2370), 0.0148, 3),
    (60.0, 0.48, (0.0290, -0.0490, 0.2400), 0.0146, 1),
]
