...
def animations() -> list[tuple[str, list]]:
    ...
    idle = [
        ...
        (18, {hipc: (2.5, 0, 0), armL: (-5, 0, 7), armR: (-5, 0, -7), neck: (-2.5, 0, 0)}),
        (36, {hipc: (0, 0, 0), armL: (0, 0, 4), armR: (0, 0, -4), neck: (0, 0, 0)}),
    ]

    walk = [
        (1, {legL: (26, 0, 0), legR: (-26, 0, 0), shinL: (-12, 0, 0), shinR: (10, 0, 0),
             armL: (-24, 0, 6), armR: (24, 0, -6), hipc: (3, 0, 0)}),
        (8, {legL: (0, 0, 0), legR: (0, 0, 0), shinL: (-4, 0, 0), shinR: (-4, 0, 0),
             armL: (0, 0, 6), armR: (0, 0, -6), hipc: (6, 0, 0)}),
        (15, {legL: (-26, 0, 0), legR: (26, 0, 0), shinL: (10, 0, 0), shinR: (-12, 0, 0),
              armL: (24, 0, 6), armR: (-24, 0, -6), hipc: (3, 0, 0)}),
        (22, {legL: (0, 0, 0), legR: (0, 0, 0), shinL: (-4, 0, 0), shinR: (-4, 0, 0),
              armL: (0, 0, 6), armR: (0, 0, -6), hipc: (6, 0, 0)}),
        (29, {legL: (26, 0, 0), legR: (-26, 0, 0), shinL: (-12, 0, 0), shinR: (10, 0, 0),
              armL: (-24, 0, 6), armR: (24, 0, -6), hipc: (3, 0, 0)}),
    ]
    ...
    attack = [
        ...
        (5, {hipc: (-10, 0, -8), armR: (-105, 0, -20), foreR: (-35, 0, 0), neck: (6, 0, 0)}),
        (10, {hipc: (16, 0, 10), armR: (58, 0, 14), foreR: (10, 0, 0), neck: (-10, 0, 0)}),
        (20, {hipc: (0, 0, 0), armR: (0, 0, -4), foreR: (0, 0, 0), neck: (0, 0, 0)}),
    ]

    hit = [
        (1, {hipc: (0, 0, 0), neck: (0, 0, 0), armL: (0, 0, 4), armR: (0, 0, -4)}),
        (4, {hipc: (-20, 0, 0), neck: (-14, 0, 0), armL: (-18, 0, 22), armR: (-18, 0, -22)}),
        (14, {hipc: (0, 0, 0), neck: (0, 0, 0), armL: (0, 0, 4), armR: (0, 0, -4)}),
    ]

    die = [
        (1, {hipc: (0, 0, 0), neck: (0, 0, 0), legL: (0, 0, 0), legR: (0, 0, 0)}),
        (10, {hipc: (-28, 0, 0), neck: (-18, 0, 0), legL: (18, 0, 0), legR: (18, 0, 0),
              armL: (-40, 0, 30), armR: (-40, 0, -30)}),
        (26, {hipc: (-82, 0, 0), neck: (-30, 0, 0), legL: (52, 0, 0), legR: (48, 0, 0),
