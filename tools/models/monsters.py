...
# 造形は tools/models/akubitokage.py(ベースケージ+Subdivision)にある。
# ここに残すのは状態アニメーションだけ。ボーン名は akubitokage.BONES_HALF
# と一致している(hip-chest / chest-head / snout-jaw / chest-legF.L,R /
# hip-legB.L,R / hip-tail1)。
AKUBI_HEIGHT = akubitokage.HEIGHT


def build_akubitokage():
    return akubitokage.build()
