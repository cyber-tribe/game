...
// wasuremizuchi・kinokootoko・houshitobi・nebosukegaeru・madoromigumo は
...
// plan/archive/model-ashiatodori.md・plan/archive/model-wasuremizuchi.md・
// plan/archive/model-kinokootoko.md・plan/archive/model-houshitobi.md・
// plan/archive/model-nebosukegaeru.md・plan/archive/model-madoromigumo.md で
// それぞれ専用モデルを新規に作った
