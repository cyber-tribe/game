...
const SIZE_BUDGET: Record<string, number> = {
   ...
   * 同じ比率だと 1,400KB だが、`handbook/hand-painted-standard.md` 3 の
   * 手描き Base Color を骨へ入れた時点で
   *   - UV(smart_uv)が頂点属性として増える  約 +240KB
   *   - 骨・四肢のアルベド2枚(256/192)      約 +100KB
   * ぶん増える。これは「単色マテリアルを貼らない」規約を守る費用。
   * 最後に棘と芽(主要蔓と頭部の蔦のみ)で +1,300三角形。
   * 合わせて 1,750KB とする。ガルドの 2,600KB より小さい。
   */
  honegarami: 1750 * 1024,
};
